...
import { Activity, Stethoscope, Shield, Zap, CheckCircle } from "lucide-react";
      ...
      <header className="bg-card/80 backdrop-blur-md shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 px-4 py-2 bg-gradient-success rounded-full shadow-sm">
              <Shield className="h-4 w-4 text-white" />
              <span className="text-sm font-medium text-white">Medical Grade</span>
            </div>
          </div>
        </div>
      </header>
